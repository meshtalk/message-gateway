...
public class DatabaseManager {
    ...
    public List<Handshake> getHandshakesForChat(UUID uuid) throws SQLException {
        ...
        if (res.isEmpty()) {
            throw new NoResultException("No handshakes found for chatId: '" + uuid + "'");
        } else {
            return res;
        }
    }
    ...
    public Handshake getHandshakeById(UUID uuid) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            throw new NoResultException("No handshake found for id: '" + uuid + "'");
        }
    }
    ...
    public List<Handshake> getHandshakesForSender(UUID uuid) throws SQLException {
        ...
        if (res.isEmpty()) {
            throw new NoResultException("No handshakes found for senderId: '" + uuid + "'");
        } else {
            return res;
        }
    }
